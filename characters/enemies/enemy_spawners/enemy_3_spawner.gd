...
@export var bird_enemy_melee_scene = preload("res://characters/enemies/assets/scenes/bird_enemies_melee/bird_enemy_3_melee.tscn")
@export var bird_enemy_ranged_scene = preload("res://characters/enemies/assets/scenes/bird_enemies_ranged/bird_enemy_3_ranged.tscn")
@export var reptile_enemy_melee_scene = preload("res://characters/enemies/assets/scenes/reptile_enemies_melee/reptile_enemy_3_melee.tscn")
@export var bird_enemy_melee_spawn_weight = 60
@export var bird_enemy_ranged_spawn_weight = 30
@export var reptile_enemy_meleed_spawn_weight = 10
...
@export var max_pitch_scale = 0.9
...
var enemy_types = [
	{"scene": bird_enemy_melee_scene, "weight": bird_enemy_melee_spawn_weight},  # 60% chance to spawn
...
func _spawn_enemy():
	...
	for enemy_type in enemy_types:
		...
		if random_pick < current_sum:
			...
			$Enemy3SpawnEffect/SpawnFlames.restart() # Spawn effects
			$Enemy3SpawnEffect/SpawnSmoke.restart() # Spawn effects
...
func play_spawn_sound():
	...
	enemy_3_spawn_sound.pitch_scale = random_pitch
	enemy_3_spawn_sound.play()
